            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-12">
                ...
                <div className="lg:w-1/3">
                    <div className="bg-gray-50 rounded-lg px-4">
                        <h4 className="text-lg font-semibold text-blue-800 mb-4">Conference Videos</h4>
                            ...
                            {videos.map((video, index) => (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h5 className={`text-sm font-medium line-clamp-2 leading-tight ${
                                            selectedVideo === index ? 'text-orange-700' : 'text-gray-800'
                                        }`}>
                                            {video.title}
                                        </h5>
                                        <p className="text-xs text-gray-500 mt-1">IRSK Conference</p>
                                    </div>
                                </div>
                            ))}
                        </div>
